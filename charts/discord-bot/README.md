...
![Version: 0.21.4](https://img.shields.io/badge/Version-0.21.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 852832bea4fdd81a2a8c112838f38c39400765bd](https://img.shields.io/badge/AppVersion-852832bea4fdd81a2a8c112838f38c39400765bd-informational?style=flat-square)
...
| Key | Type | Default | Description |
|-----|------|---------|-------------|
| image | object | `{"pullPolicy":"Always","repository":"xxczaki/discord-bot","tag":"852832bea4fdd81a2a8c112838f38c39400765bd"}` | General configuration of the Redis instance used for query caching and storing usage statistics |
